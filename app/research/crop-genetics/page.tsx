    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-slate-50 to-gray-100 py-20 lg:py-32">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-foreground mb-6" style={{fontFamily: "'ITC Garamond Std', Georgia, 'Times New Roman', serif", fontWeight: 500, fontSize: "clamp(3rem, 4vw + 0.5rem, 4.5rem)", lineHeight: "1.1", letterSpacing: "-0.01em", color: "hsl(var(--foreground))"}}>Crop Genetics & Breeding</h1>
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-headline text-foreground mb-4">Research Focus Areas</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-muted-foreground">Advanced genomic analysis and trait mapping for crop improvement programs.</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-muted-foreground">Marker-assisted selection and genomic breeding technologies.</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-muted-foreground">Development of improved traits for yield, quality, and stress tolerance.</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-muted-foreground">Comprehensive field trials and performance evaluation programs.</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <section className="py-16 lg:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-headline text-foreground mb-8 text-center">Current Research Programs</h2>
            
            <div className="space-y-8">
              <div className="bg-white p-8 rounded-lg shadow-lg">
                <h3 className="text-title text-foreground mb-4">Yield Enhancement Program</h3>
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg">
                <h3 className="text-title text-foreground mb-4">Disease Resistance Research</h3>
                <p className="text-muted-foreground mb-4">
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg">
                <h3 className="text-title text-foreground mb-4">Climate Adaptation Initiative</h3>
                <p className="text-muted-foreground mb-4">
      ...
      <section className="py-16 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-headline mb-4">Collaborate on Crop Genetics Research</h2>
