      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <h2 className="text-headline text-foreground mb-4">Conformance Status</h2>
            ...
            <h2 className="text-headline text-foreground mb-4">Accessibility Features</h2>
            ...
            <h2 className="text-headline text-foreground mb-4">Feedback</h2>
