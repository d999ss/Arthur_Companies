    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-purple-50 to-pink-100 py-20 lg:py-32">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-foreground mb-6" style={{fontFamily: "'ITC Garamond Std', Georgia, 'Times New Roman', serif", fontWeight: 500, fontSize: "clamp(3rem, 4vw + 0.5rem, 4.5rem)", lineHeight: "1.1", letterSpacing: "-0.01em", color: "hsl(var(--foreground))"}}>Pet Food Manufacturing</h1>
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-headline text-foreground mb-4">Premium Pet Food Manufacturing</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-muted-foreground">Modern production lines for dry, wet, and specialty pet food products.</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-muted-foreground">HACCP certified facilities with comprehensive food safety protocols.</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-muted-foreground">Rigorous testing and quality assurance throughout the production process.</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-muted-foreground">Complete packaging solutions and distribution network management.</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <section className="py-16 lg:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-headline text-foreground mb-8 text-center">Manufacturing Capabilities</h2>
            
            <div className="space-y-8">
              <div className="bg-white p-8 rounded-lg shadow-lg">
                <h3 className="text-title text-muted-foreground mb-4">Dry Pet Food Production</h3>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold text-foreground mb-2">Production Capabilities</h4>
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg">
                <h3 className="text-title text-muted-foreground mb-4">Specialty Products</h3>
                <p className="text-muted-foreground mb-4">
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg">
                <h3 className="text-title text-muted-foreground mb-4">Private Label Services</h3>
                <p className="text-muted-foreground mb-4">
      ...
      <section className="py-16 bg-purple-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-headline mb-4">Bring Your Pet Food Vision to Life</h2>
